        ...
        <div className="container">
            <div className="row justify-content-md-center">
                <div className="col-md-3">
                    <button type="button" className="btn btn-outline-danger btn-lg ml-2 mr-2"
                ...
                <div className="col-md-4 ">
                    <button onClick={() => props.resCounter(props.index)} type="button"
                            className="btn btn-outline-success btn-lg ml-2 mr-2">{resetIco}</button>
                   <span className="h3">{props.count}</span>
                    <button onClick={() => props.delCounter(props.index)} type="button"
                            className="btn btn-outline-dark btn-lg ml-2 mr-2">{trashIco}</button>

                </div>
                <div className="col-md-4">
                    <button type="button" className="btn btn-outline-success btn-lg ml-2 mr-2"
                            onClick={() => props.plusMinus(props.index, 3)}>+3
                    </button>
                    <button type="button" className="btn btn-outline-success btn-lg ml-2 mr-2"
                            onClick={() => props.plusMinus(props.index, 2)}>+2
